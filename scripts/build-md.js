...
const SITE = "https://businessinternetsearch.sdfkjh.com";

const SKIP_DIRS = new Set(["node_modules", "scripts", "functions", "images", "dist", ".git", ".claude"]);
...
function convert(rel) {
  ...
  const title = (doc.querySelector("title")?.textContent || "Business Internet Quotes").trim();
